        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastLoginAttempt = table.Column<DateTime>(nullable: true),
                    MutliFactorAuthKind = table.Column<int>(nullable: false),
                    OpenIdConnectId = table.Column<Guid>(nullable: false),
                    PasswordResetRequired = table.Column<bool>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountProperties", x => x.Id);
                    table.UniqueConstraint("AK_AccountProperties_OpenIdConnectId", x => x.OpenIdConnectId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountProperties_OpenIdConnectId",
                table: "AccountProperties",
                column: "OpenIdConnectId",
                unique: true);
